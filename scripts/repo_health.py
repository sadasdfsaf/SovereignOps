...
REQUIRED_PATHS = [
    ...
    "apps/web/tests/localStore.test.mjs",
    "apps/web/tests/tasks-documents.test.mjs",
    ...
    "packages/cli/tests/commands.test.mjs",
    ...
    "packages/sdk-js/tests/workspace.test.mjs",
    ...
    "services/sync/src/cursors.ts",
    "services/sync/src/eventCatalog.ts",
    "services/sync/src/replay.ts",
    "services/sync/tests/sync.test.mjs",
