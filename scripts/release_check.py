...
CHECK_SPECS: tuple[CheckSpec, ...] = (
    ...
    CheckSpec(
        ...
        description="Validate ingest connector manifest docs, connector API client and replay, API fixture replay, SDK fixture client, connector API manifest schema fixtures, Web connector API-state, and OpenAPI docs.",
        command=(
            PYTHON,
            "-m",
            "unittest",
