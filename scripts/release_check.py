...
CHECK_SPECS: tuple[CheckSpec, ...] = (
    ...
    CheckSpec(
        ...
        description="Validate workspace session snapshot retention cleanup redaction, path safety, inventory preview, SDK API client, schema fixtures, API replay, and dry-run controls.",
        command=(
            "node",
            "--test",
            "tests/security/workspace_session_snapshot_retention_cleanup_threats.test.mjs",
    ...
    CheckSpec(
        ...
        description="Validate workspace session snapshot retention cleanup docs, fixture, inventory preview, SDK API client, schema fixtures, API replay, OpenAPI, CLI, API, Web wiring, and E2E replay.",
        command=(
            PYTHON,
            "-m",
            "unittest",
