...
export * from "./ingestConnectorMcpApiReplay.ts";
...
export * from "./ingestConnectorMcpPreview.ts";
...
export * from "./workspaceSessionSnapshotRetentionCleanupInventoryApiReplay.ts";
...
import { runIngestConnectorMcpPreviewCli } from "./ingestConnectorMcpPreview.ts";
...
import { runWorkspaceSessionSnapshotRetentionCleanupInventoryApiReplayCli } from "./workspaceSessionSnapshotRetentionCleanupInventoryApiReplay.ts";
...
export async function runCli(
  ...
  options: Parameters<typeof runCoreCli>[1] &
    ...
    Parameters<typeof runIngestConnectorMcpApiReplayCli>[1] &
    ...
    Parameters<typeof runIngestConnectorMcpPreviewCli>[1] &
    ...
    Parameters<typeof runWorkspaceSessionSnapshotRetentionCleanupInventoryApiReplayCli>[1] &
  ...
  return (
    ...
    (await runIngestConnectorMcpPreviewCli(argv, options)) ??
    (await runIngestConnectorMcpApiReplayCli(argv, options)) ??
