...
REQUIRED_COMMANDS = (
    ...
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-preview-requests.valid.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-preview-requests.invalid.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-preview-requests.schema.json",
)
