...
DOC = ROOT / "docs" / "mcp-approval-evidence-records-api.md"
...
REQUIRED_COMMANDS = (
    ...
    r"python -m json.tool examples\mcp\approval-evidence-records-requests.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-record.valid.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-record.invalid.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-record.schema.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-records-requests.valid.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-records-requests.invalid.json",
    r"python -m json.tool packages\schemas\fixtures\mcp-approval-evidence-records-requests.schema.json",
)
...
class McpApprovalEvidenceRecordsApiDocsTests(unittest.TestCase):
    @classmethod
