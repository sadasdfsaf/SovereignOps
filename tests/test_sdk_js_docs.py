...
EXPECTED_COMMANDS = (
    ...
    r"node packages\sdk-js\tests\client-plugin-review-artifact.test.mjs",
    r"node packages\sdk-js\tests\client-plugin-review-artifact-record.test.mjs",
    r"node packages\sdk-js\tests\client-mcp-approval-evidence.test.mjs",
    r"node packages\sdk-js\tests\client-mcp-approval-evidence-record.test.mjs",
...
class SdkJsDocsTests(unittest.TestCase):
    ...
    def test_document_has_required_sections_references_symbols_and_commands(self) -> None:
        ...
        for phrase in (
            ...
            "review and approval evidence clients",
            "shared schema validators before fake fetch is called",
            "API route tests, SDK fake-fetch tests, CLI replay, and Web state builders",
            "local-only",
            "repo-relative",
            "sensitive-looking values should remain `[REDACTED]`",
            "must not use global fetch as a fallback",
        ):
